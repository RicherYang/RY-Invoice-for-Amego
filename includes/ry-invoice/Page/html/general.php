...
<h2 class="title"><?php esc_html_e('Buyer options', 'ry-invoice-for-amego'); ?></h2>
<table class="form-table" role="presentation">
    <tr>
        <th scope="row"><?php esc_html_e('Buyer name', 'ry-invoice-for-amego'); ?></th>
        <td>
            <fieldset>
                <legend class="screen-reader-text"><span><?php esc_html_e('Use real name', 'ry-invoice-for-amego'); ?></span></legend>
                <label for="buyer_name"><input name="buyer_name" type="checkbox" id="buyer_name" value="yes" <?php checked($general_info['buyer']['name']); ?>>
                    <?php esc_html_e('Use real name', 'ry-invoice-for-amego'); ?></label>
                <p class="description">
                    <?php echo esc_html(sprintf(__('If disabled, fallback to "%s" as the name.', 'ry-invoice-for-amego'), __('Customer', 'ry-invoice-for-amego'))); ?>
                    <?php esc_html_e('Only for personal invoice.', 'ry-invoice-for-amego'); ?>
                </p>
            </fieldset>
        </td>
    </tr>
    <tr>
        <th scope="row"><?php esc_html_e('Buyer address', 'ry-invoice-for-amego'); ?></th>
        <td>
            <fieldset>
                <legend class="screen-reader-text"><span><?php esc_html_e('Use real address', 'ry-invoice-for-amego'); ?></span></legend>
                <label for="buyer_address"><input name="buyer_address" type="checkbox" id="buyer_address" value="yes" <?php checked($general_info['buyer']['address']); ?>>
                    <?php esc_html_e('Use real address', 'ry-invoice-for-amego'); ?></label>
                <p class="description">
                    <?php echo esc_html(sprintf(__('If disabled, fallback to "%s" as the address.', 'ry-invoice-for-amego'), __('Taiwan', 'ry-invoice-for-amego'))); ?>
                </p>
            </fieldset>
        </td>
    </tr>
...
<table class="form-table" role="presentation">
    <tr>
        <th scope="row"><label for="count_precision"><?php esc_html_e('Item count precision', 'ry-invoice-for-amego'); ?></label></th>
        <td>
    ...
    <tr>
        <th scope="row"><label for="amount_precision"><?php esc_html_e('Item amount precision', 'ry-invoice-for-amego'); ?></label></th>
        <td>
    ...
    <tr>
        <th scope="row"><label for="donate"><?php esc_html_e('Default donate number', 'ry-invoice-for-amego'); ?></label></th>
        <td>
            ...
            <p class="description">
                <?php echo wp_kses(
                    sprintf(
                        ...
                        __('Separate donate numbers with commas. View <a href="%s" target="_blank">full list</a>.', 'ry-invoice-for-amego'),
