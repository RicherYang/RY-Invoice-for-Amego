...
final class RY_IFAMEGO_WC_Admin_Invoice
{
    private static ?self $_instance = null;

    public static function instance(): RY_IFAMEGO_WC_Admin_Invoice
    {
    ...
    {
        include_once RY_IFAMEGO_PLUGIN_DIR . 'woocommerce/admin/meta-boxes/class-wc-meta-box-invoice-data.php';
        add_action('woocommerce_admin_order_data_after_billing_address', ['RY_IFAMEGO_MetaBox_Invoice_Data', 'output']);

        include_once RY_IFAMEGO_PLUGIN_DIR . 'woocommerce/admin/settings/invoice.php';
        RY_IFAMEGO_WC_Admin_Setting_Invoice::instance();
    ...
    public function add_scripts()
    {
        ...
        if (in_array($screen_id, ['shop_order', 'edit-shop_order', 'woocommerce_page_wc-settings', 'woocommerce_page_wc-orders'])) {
            ...
            wp_localize_script('ry-invoice-admin-invoice', 'RyWaiAdminInvoiceParams', [
                'i18n' => [
                    'get' => __('Issue invoice.<br>Please wait.', 'ry-invoice-for-amego'),
                    'cancel' => __('Cancel get invoice.<br>Please wait.', 'ry-invoice-for-amego'),
                    'invalid' => __('Invalid invoice.<br>Please wait.', 'ry-invoice-for-amego'),
                ],
                '_nonce' => [
