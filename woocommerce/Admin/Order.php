...
namespace RY\Invoice\Amego\WooCommerce\Admin;
...
final class Order
{
    ...
    {
        add_action('woocommerce_admin_order_data_after_billing_address', ['RY\Invoice\Amego\WooCommerce\Admin\MetaBoxes\Info', 'output']);
