...
$(function () {
    if ($('#RY_IFAMEGO_get_mode').length) {
        $('#RY_IFAMEGO_get_mode').on('change', function () {
            if ($(this).val() == 'manual') {
                $('#RY_IFAMEGO_skip_foreign_order').closest('tr').hide();
                $('#RY_IFAMEGO_get_delay_time').closest('tr').hide();
            } else {
                $('#RY_IFAMEGO_skip_foreign_order').closest('tr').show();
                $('#RY_IFAMEGO_get_delay_time').closest('tr').show();
            }
        }).trigger('change');
    }
    ...
    $('.ajax-amego-invoice').on('click', function () {
